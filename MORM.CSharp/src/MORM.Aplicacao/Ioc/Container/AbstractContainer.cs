...
namespace MORM.Aplicacao.Ioc.Container
{
    ...
    {
        //private static AbstractContainer _instance;
        ...
        #region register
        public void Register(Type IObject, Type TObject, RegisterTipo tipo = RegisterTipo.Singleton)
        {
            _registeredTypes.Add(IObject, new RegisterClasse(IObject, TObject, tipo));
        }
        ...
        public void RegisterAll(Type[] types)
        {
            foreach (var type in types)
                Register(type, type, RegisterTipo.Singleton);
        }
        #endregion
